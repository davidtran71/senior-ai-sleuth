    ...
    <div className="min-h-screen bg-background py-8 px-6">
      <div className="max-w-4xl mx-auto">
            ...
            {slide.type !== 'intro' && currentSlide !== 1 && currentSlide !== 2 && (
              <div className="flex items-center gap-2 bg-accent/10 px-4 py-2 rounded-lg border border-accent/20">
                ...
                <span className="text-lg font-bold tracking-wider">
                  {currentSlide === 3 ? 'CASE #1/4' : `CASE #${String(currentSlide + 1).padStart(2, '0')} / ${String(totalSlides).padStart(2, '0')}`}
                </span>
              </div>
            )}
          </div>
        ...
        <div className="flex justify-between items-center gap-4">
          ...
          >
            <ArrowLeft className="mr-2 h-5 w-5" />
            {currentSlide === 1 || currentSlide === 2 || currentSlide === 3 ? 'Back' : 'Previous Case'}
          </Button>
          ...
          {currentSlide === totalSlides - 1 ? (
            ...
            >
              {slide.type === 'intro' ? 'AI Briefing' : currentSlide === 1 ? 'AI Uses' : currentSlide === 2 ? 'Case 1: AI Text' : currentSlide === 3 ? 'Next' : 'Next Case'}
