      ...
      <div className="max-w-4xl mx-auto">
            ...
            {slide.type !== 'intro' && currentSlide !== 1 && currentSlide !== 2 && (
              <div className="flex items-center gap-2 bg-accent/10 px-4 py-2 rounded-lg border border-accent/20">
                ...
                <span className="text-lg font-bold tracking-wider">
                  {currentSlide === 3 || currentSlide === 4 ? 'CASE #1/4' : currentSlide === 5 || currentSlide === 6 ? 'CASE #2/4' : `CASE #${String(currentSlide + 1).padStart(2, '0')} / ${String(totalSlides).padStart(2, '0')}`}
                </span>
              </div>
            )}
          </div>
        ...
        <div className="flex justify-between items-center gap-4">
          ...
          {currentSlide === totalSlides - 1 ? (
            ...
            >
              {slide.type === 'intro' ? 'AI Briefing' : currentSlide === 1 ? 'AI Uses' : currentSlide === 2 ? 'Case 1: AI Text' : currentSlide === 3 || currentSlide === 5 ? 'Next' : 'Next Case'}
