...
const Index = () => {
  ...
  const modules = [{
    ...
    desc: "Learn what AI is and how criminals use it online"
  }, {
    num: 2,
    title: "Spotting Fake Text",
    desc: "Identify AI-generated scams, phishing emails and messages"
  }, {
    num: 3,
    title: "Detecting Fake Images",
    desc: "Recognise manipulated photos and AI-generated images"
  }, {
    num: 4,
    title: "Voice Clones & Audio",
    desc: "Spot synthetic voices and deepfake audio scams"
  }, {
    num: 5,
  ...
  return <div className="min-h-screen bg-white font-sans">
      {/* Hero Section */}
      <section className="px-6 pb-16 pt-4 relative bg-cover bg-center bg-no-repeat" style={{
      backgroundImage: `url(${heroBackground})`
    }}>
        {/* Header - Inside Hero */}
        <header className="max-w-6xl mx-auto py-4 mb-4">
          <AnimatedElement type="fadeIn" duration={0.4}>
            <CareSideLogo />
          </AnimatedElement>
        </header>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-8">
            {/* Hero Content - Card */}
            <AnimatedElement type="fadeUp" delay={0.1} className="flex-1">
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 lg:p-10 relative z-10 shadow-sm">
            ...
            <AnimatedElement type="slideRight" delay={0.2} className="flex-1 flex justify-center relative">
              <img src={robotShield} alt="Robot with shield" className="w-72 lg:w-96 h-auto relative z-10" />
            </AnimatedElement>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            {/* Right - Content */}
            <AnimatedElement type="fadeUp" delay={0.15} className="flex-1">
              ...
              <p className="text-[#4A5568] text-base lg:text-lg mb-4">
                Scammers use AI to create convincing fake emails, voice calls, images, and videos targeting seniors. This fun training will help you develop skills to recognise digital threats and stay safe online.
              </p>
        ...
        <div className="max-w-5xl mx-auto">
          <AnimatedElement type="fadeUp">
            <div className="rounded-3xl p-8 lg:p-12 flex justify-end bg-[#FBF6E8] relative overflow-hidden">
              <div className="absolute inset-0 hidden lg:block bg-cover bg-center bg-no-repeat" style={{
              ...
              <div className="lg:w-1/2 text-center lg:text-left relative z-10">
                ...
                <Button onClick={handleStartTraining} className="bg-[#0A1628] hover:bg-[#1a2840] text-white rounded-lg px-8 py-4 text-base font-medium">
                  Start Training
                </Button>
              </div>
            </div>
